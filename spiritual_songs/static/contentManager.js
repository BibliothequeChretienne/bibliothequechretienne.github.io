...
// // Function to handle song navigation
// function navigateSong(offset) {
//   let numero = parseInt(localStorage.getItem('numero'));

//   if (numero + offset < 1 || numero + offset > 100) {
//     alert(`Песня № ${numero + offset}`);
//   } else {
//     numero += offset;
//     localStorage.setItem('numero', numero);
...
//     const songTitle = titles[numero];
//     const textFilePath = `../song_texts/${numero}.txt`; // looking for the corresponding text file
//     const svgFilePath = `../song_notes/${numero}.svg`;
//     const mp3FilePath = `../song_melodies/${numero}_`;

//     localStorage.setItem('songTitle', songTitle);

//     // Fetching the notes
//     fetchContent(svgFilePath, 'svgFilePath');

//     // Fetching mp3 file
//     fetchContent(mp3FilePath, 'savedMP3');

//     // Fetching text file
//     fetchContent(textFilePath, 'textContent', () => {
//       window.location.href = 'song.html';
//     });
//   }
// }

// // Function to fetch content and store in localStorage
// function fetchContent(filePath, storageKey, callback) {
//   fetch(filePath)
//     .then(response => response.blob())
//     .then(content => {
...
// let startX;
// let startY;
// let threshold = 50; // Adjust the threshold according to your preference
